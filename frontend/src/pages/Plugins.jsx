      ...
      <div className="bg-white border border-gray-200 rounded-xl w-full max-w-2xl shadow-2xl">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-brand-text">Plugin Template</span>
          </div>
          <div className="flex items-center gap-2">
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold text-brand-text flex items-center gap-2">
            <Puzzle size={18} className="text-brand-accent" /> Plugins
          </h1>
          <p className="text-xs text-gray-500 mt-1">
            {plugins.length} plugin{plugins.length !== 1 ? 's' : ''} loaded from{' '}
            <code className="text-gray-500">/app/plugins</code>
          </p>
        </div>
        <div className="flex items-center gap-2">
      ...
      {loading ? (
        ...
        <div className="card p-10 text-center">
          ...
          <p className="text-gray-500 text-sm font-medium mb-1">No plugins loaded</p>
